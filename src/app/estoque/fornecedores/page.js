          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="flex mt-4 md:ml-4 md:mt-0">
              <Link href="estoque/fornecedores/novo">
                <button
                  type="button"
                  className="inline-flex items-center px-3 py-2 ml-3 text-sm font-semibold text-white bg-amber-500 rounded-md shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400"
                >
